                  ...
                  >
                    ...
                    <div class="p-6 md:p-8">
                      ...
                      >
                        ...
                        >
                          <!-- Image Card -->
                          <div class="bg-white border border-[#E7E7E7] rounded-[4px] overflow-hidden">
                            <!-- Image Container -->
                            <div class="relative w-full bg-gray-100 overflow-hidden" style="aspect-ratio: 274/152;">
                              <img
                                [src]="image.imageUrl"
                                [alt]="image.title"
                            ...
                            <div class="p-4 text-center">
                              <h3 class="text-base font-medium text-[#282A36] line-clamp-2">
                                {{ image.title }}
                              </h3>
                              <p
                                *ngIf="image.caption"
